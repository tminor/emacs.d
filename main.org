...
- [[#shell-and-term-modes][Shell and Term Modes]]
  ...
  - [[#make-emacs-use-path][Make Emacs use =$PATH=]]
- [[#mail][Mail]]
  - [[#notmuch][Notmuch]]
  - [[#elisp][Elisp]]
- [[#org-mode][Org-mode]]
...
*** Custom set variables/faces/etc.
:PROPERTIES:
:HASH:     -1963024755265275210
:MODIFIED: 2019-03-07 08:50
:END:
...
*** Delete specified buffers at midnight
:PROPERTIES:
:HASH:     -1963024755265275210
:MODIFIED: 2019-03-07 08:50
:END:

Given a list of regular expressions, kill matched buffer names at
midnight.
...
#+BEGIN_SRC emacs-lisp
  (use-package clipmon
    ...
    (setq clipmon-transform-remove
          (with-temp-buffer
            (insert-file-contents "~/.emacs.d/clipmon-ignore")
            (buffer-string))))
#+END_SRC
