...
*** Config
:PROPERTIES:
:HASH:     431750acad80c51ed1ef2fb93dbfba68
:MODIFIED: 2019-03-11 15:46:37
:END:
...
*** Config
:PROPERTIES:
:HASH:     628aac4674ae5f27fe1131246eb7700b
:MODIFIED: 2019-03-11 15:46:37
:END:
...
#+BEGIN_SRC emacs-lisp
  (use-package org-capture
    ...
    (tm/org-make-refile-command work-project-todos
                                `((,(concat org-base-directory "work/work.org") :todo . "PROJECT")))
    (tm/org-make-refile-command home-project-todos
                                `((,(concat org-base-directory "home/home.org") :todo . "PROJECT")))
    :general
    (tm/leader-def
      :infix "o"
      :prefix-command 'tm/org-prefix-command
