...
:PROPERTIES:
:HASH:     7c7b2cb602ad250d7f814bd1675fff36
:MODIFIED: 2019-06-28 16:37:22
:END:
:LOGBOOK:
...
:PROPERTIES:
:HASH:     546d3b7f136d55798a810b5525e61bef
:MODIFIED: 2019-06-28 16:28:10
:END:
...
:PROPERTIES:
:HASH:     03d3575e7612c817e64796d9834ca038
:MODIFIED: 2019-06-26 13:32:05
:END:
...
#+begin_src emacs-lisp
  (let ((rule `(,(rx bos "*" (one-or-more anything) "*"
                     (optional "<" (one-or-more anything) ">") eos)
...
***** TODO Tweak =display-buffer=                                 :hard:
:PROPERTIES:
:HASH:     80fe6795985b5016f8a6b9dc42caa97d
:MODIFIED: 2019-06-28 16:39:35
:END:
:LOGBOOK:
- State "TODO"    from ""        [2019-06-27 Thu 11:27]
:END:

- Prefer =(side . bottom)= for Eshell
- [[https://gitlab.com/jabranham/emacs/blob/master/init.el#L2542-2673][Extensive customization example]]
...
:PROPERTIES:
:HASH:     789c2cdebdf321c8e23b2cd14fcde827
:MODIFIED: 2019-06-29 11:34:46
:END:
...
*** Buffer cleanup
:PROPERTIES:
:HASH:     c21841de5697cf64d22cb2290a059015
:MODIFIED: 2019-06-28 16:44:46
:END:
...
:PROPERTIES:
:HASH:     01674a5f97edd250f32553898be29d70
:MODIFIED: 2019-06-29 11:34:46
:END:
...
*** Config
:PROPERTIES:
:HASH:     ffe7565e48db25e6fdd4a56a2cac84ed
:MODIFIED: 2019-06-29 11:17:27
:END:
...
:PROPERTIES:
:HASH:     3da6259d0e62ec86d27ccba9a13c2fe6
:MODIFIED: 2019-06-28 16:53:48
:END:
:LOGBOOK:
...
:PROPERTIES:
:HASH:     5031ff57327d1d7058e4ad56ac742eb6
:MODIFIED: 2019-06-28 16:53:59
:END:
:LOGBOOK:
...
*** Config
:PROPERTIES:
:HASH:     9b0a1a89fc980abbb2f4acbaae5b5040
:MODIFIED: 2019-06-27 21:31:43
:END:
  ...
  (use-package org-capture
    ...
    (defmacro tm/org-get-headings-command (fn-suffix target)
      ...
      `(defun ,(intern (concat "tm/org-get-headings-"
         ...
         (let* ((file (concat (if (string= ,target
           ...
           (with-current-buffer
               buf
             ;; Gets headings from TARGET and fontifies them before
             ;; collecting them in `heading-point-alist', each cons cell
             ;; of which reprents a heading (with text properties) pointing
             ;; at the value for that heading's point.
             ;; `heading-point-alist' is passed to `completing-read' read,
             ;; ultimately calling `goto-char' against the point from the
             ;; chosen cons cell.
    ...
    (setq
     ...
     `(
       ...
       ("l" "Link" entry
        ;; Target
        (function (tm/org-get-headings notes))
        ;; Template
        ,(concat "* %(format-time-string org-journal-time-format) "
...
*** TODO [[https://addons.mozilla.org/en-US/firefox/addon/org-capture/][=org-capture= Extension]]                                :moderate:
:PROPERTIES:
:HASH:     bd7b1abdc80b2cda6113b233b217ed84
:MODIFIED: 2019-06-29 12:19:19
:END:
:LOGBOOK:
...
#+end_quote
*** TODO Refine capture templates/ensure new lines for new captures :easy:
:PROPERTIES:
:HASH:     a3e3e18af6079cf7f7b07a276f3ecf47
:MODIFIED: 2019-06-29 12:19:19
:END:
:LOGBOOK:
- State "TODO"    from ""        [2019-06-29 Sat 12:18]
:END:
** Blog Publishing
:PROPERTIES:
