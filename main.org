...
** Elisp
:PROPERTIES:
:HASH:     67db27d8239405b624bafb53a730c1d3
:MODIFIED: 2019-05-28 11:00:03
:END:
...
** TODO Notmuch
:PROPERTIES:
:HASH:     70c7f6e01267a7420fe923569e0b6623
:MODIFIED: 2019-05-29 09:22:13
:END:
:LOGBOOK:
...
#+BEGIN_SRC emacs-lisp
  (use-package notmuch
    ...
    (run-at-time "5 sec" nil #'tm/notmuch-refresh-feed-buffer)
    ...
    (setq notmuch-saved-searches
          '((:name "inbox"
            ...
            (:name "git issues"
             :query "tag:lists/854 and date:1week..now"
             :count-query "tag:lists/854 and date:1week..now and tag:unread")
            (:name "feed"
             :query "date:\"2hours..now\" and not subject:\"/[a-z]+-(dev|prod)[/][a-z]+-(dev|prod)/\"")
            (:name "nagios-gluu"
