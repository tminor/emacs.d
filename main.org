...
*** Config
:PROPERTIES:
:HASH:     7cb4541c18f9ba42ce642407d151552f
:MODIFIED: [2019-07-07 Sun 12:53]
:END:
...
*** Config
:PROPERTIES:
:HASH:     b91bee8ffdce8a6cb8ff9c853b632288
:MODIFIED: [2019-07-08 Mon 11:08]
:END:
               ...
               ((org-agenda-todo-ignore-scheduled 'past)
                (org-agenda-time-grid (quote
                                       ((daily today remove-match)
                                        ...
                                        "......" "----------------")))
                (org-agenda-span 'day)
                (org-agenda-hide-tags-regexp (rx (or "HOME" "HABIT")))))
              (todo
               "TODO"
               ((org-agenda-prefix-format
                 ,(concat "    %5(org-entry-get nil \"MODIFIED\") "))
