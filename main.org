...
:PROPERTIES:
:HASH:     51b3bd6f55dfb7536f5f23de509e2594
...
* Interface
:PROPERTIES:
:HASH:     fe66e88f5071d7ff7edcee4553777388
:MODIFIED: [2019-09-08 Sun 10:40]
:END:
...
:PROPERTIES:
:HASH:     6c913aed529e1d1844ee65d94fb01925
:MODIFIED: [2019-09-08 Sun 11:11]
:END:
...
:PROPERTIES:
:HASH:     706def7f1688c2cba86562a72944e7b3
:MODIFIED: [2019-09-09 Mon 16:59]
:END:
...
:PROPERTIES:
:HASH:     f45df9926027e2495462b43a80eb3973
:MODIFIED: [2019-09-19 Thu 13:27]
:END:
...
**** [[https://github.com/skeeto/emacs-aio][=emacs-aio=]]
:PROPERTIES:
:HASH:     d1fab2740fc32f6d5082bd03bccc9002
:MODIFIED: [2019-09-19 Thu 13:29]
:END:
...
*** Java
:PROPERTIES:
:HASH:     1848b6dae75a4d11acaf7e5d82bcdea5
:MODIFIED: [2019-09-13 Fri 15:01]
:END:

**** [[https://gist.github.com/skeeto/3178747][=javap-handler=]]
:PROPERTIES:
:HASH:     1ec197116ebebe5e10582a9e1c69efb4
:MODIFIED: [2019-09-13 Fri 15:04]
:END:
...
*** PHP
:PROPERTIES:
:HASH:     4a6613795ff293f64abe562e01bf7cc5
:MODIFIED: [2019-09-17 Tue 08:21]
:END:
...
** Notmuch
:PROPERTIES:
:HASH:     fa781a246029a5aadec3bf71ca2a6556
:MODIFIED: [2019-09-10 Tue 08:40]
:END:
:LOGBOOK:
...
*** Config
:PROPERTIES:
:HASH:     387e1ec37a13bfa1503184aa2799f0f1
:MODIFIED: [2019-09-12 Thu 14:18]
:END:
...
:PROPERTIES:
:HASH:     fadafe8116b999afa27da074f57fcc57
:MODIFIED: [2019-09-13 Fri 13:51]
:END:
  ...
  Use `notifications-notify' instead of `alert'."
    ...
    (org-pomodoro-finished
     ...
     (lambda ()
       ...
       (start-process-shell-command "yad Break timers command"
                                    nil
                                    "yadBreakTime")))
...
*** Config
:PROPERTIES:
:HASH:     c1546de39b2d74c65cc78257efab5680
:MODIFIED: [2019-09-19 Thu 08:55]
:END:
  ...
  (use-package org-agenda
    ...
    (setq org-agenda-files
          `(,(concat org-base-directory "mobile-capture.org")
            ...
            ,(concat org-base-directory "calendar/org-caldav-inbox.org")
...
:PROPERTIES:
:HASH:     74f1d3f6d46d712cd6a4a2d8c41c6cda
:MODIFIED: [2019-09-09 Mon 17:27]
:END:
...
#+begin_src emacs-lisp
  (use-package org-brain
    :straight
    (:host github :repo "Kungsgeten/org-brain")
    :init
    ...
    (setq org-id-locations-file (concat no-littering-var-directory
                                        ".org-id-locations"))
    (push '("b" "Brain" plain (function org-brain-goto-end)
            "* %i%?" :empty-lines 1)
          org-capture-templates)
    (setq org-brain-visualize-default-choices 'all)
    (setq org-brain-title-max-length 18)
...
** Org-notify
:PROPERTIES:
:HASH:     e4cfcdb26ab12fced362daf316944449
:MODIFIED: [2019-09-19 Thu 08:55]
:END:
...
** Org-caldav
:PROPERTIES:
:HASH:     40cdf8b077371bd223272e4ded70ab1d
:MODIFIED: [2019-09-19 Thu 19:25]
:END:
...
#+begin_src emacs-lisp
  (use-package org-caldav
    ...
    ;; This is the sync on close function; it also prompts for save
    ;; after syncing so no late changes get lost
...
:PROPERTIES:
:HASH:     c02980fdffa261fa3e33cc4c550064a1
:MODIFIED: [2019-09-16 Mon 16:36]
:END:
...
** =centaur-tabs=
:PROPERTIES:
:HASH:     f917af0c7b421c1f2a5fa0e3a96fbdab
:MODIFIED: [2019-09-08 Sun 12:12]
:END:
...
#+begin_src emacs-lisp
  ...
  -^^^^--------------------+-^^^^---------------------+-^^----------------+-^^---------------------------
     ^_k_^   prev group    | _H_^^     select first   | _b_ search buffer | _C-k_   kill buffer
   _h_   _l_  switch tab   | _L_^^     select last    | _g_ search group  | _C-S-k_ kill others in group
     ^_j_^   next group    | _C-h_/_C-l_ move current | ^^                | ^^
   ^^0 ~ 9^^ select window | ^^                       | ^^                | ^^
  -^^^^--------------------+-^^^^---------------------+-^^----------------+-^^---------------------------
  "
    ...
    ("C-h" centaur-tabs-move-current-tab-to-left)
    ("C-l" centaur-tabs-move-current-tab-to-right)
    ("b" ivy-switch-buffer)
