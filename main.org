...
** Org-mode
:PROPERTIES:
:HASH:     11246022048402624
:MODIFIED: 2019-03-07 14:39
:END:
...
#+BEGIN_SRC emacs-lisp
  ...
  (defun tm/skip-nonmodified ()
    "Skip org entries, which were not modified according to the
  :HASH: property"
    (let ((next-headline
           (save-excursion
