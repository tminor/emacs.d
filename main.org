...
** Gnus
:PROPERTIES:
:HASH:     0be8f4167c557c4dcaba298a64242231
:MODIFIED: 2019-06-21 16:35:51
:END:
...
#+begin_src emacs-lisp
  (use-package gnus
    ...
    (setq nnnotmuch-groups
          '((""
             ("nnnotmuch+lists.inc-ops-notifications" "tag:lists/inc-ops-notifications")
             ("nnnotmuch+lists.notmuch-commits" "tag:lists/notmuch-commits"))))
