...
#+BEGIN_SRC emacs-lisp
  (use-package org
    ...
    ;; Increase indentation based on heading level
    ...
    (add-hook 'org-after-refile-insert-hook 'tm/org-remove-inherited-local-tags)
    ...
    ;; TODO: Break long strings (I've already wrapped them in `concat')
    (setq org-capture-templates
          (quote (("t" "Templates for TODOs.")
                  ...
                  ("pp" "New PROJECT containing NOTEs and TODOs."
                   ...
                   (concat "* PROJECT [#%^{Priority: |C|B|A}] %?\nDEADLINE:%^{(DEADLINE) Date and time, please}t\n:PROPERTIES:\n:CONTEXT: %a\n:END:"))
...
:PROPERTIES:
:HASH:     1785312398235969895
:MODIFIED: 2019-03-05 17:21
:END:
...
(setq org-todo-keywords
  '((sequence "TODO(t!)" "WAITING(w@)" "HOLD(h@)" "NEXT(n@)" "MAYBE(m@)" "STUFF(s!)" "PROJECT(p!)" "|" "DONE(d@)" "CANCELLED(c@)")))
#+END_SRC
...
** Window Management
:PROPERTIES:
:HASH:     1959195950329798149
:MODIFIED: 2019-03-05 17:15
:END:

*** hydra Window Functions
:PROPERTIES:
:HASH:     593261976847696897
:MODIFIED: 2019-03-05 17:15
:END:
...
** Hydra for hydras above
:PROPERTIES:
:HASH:     -1549122272347755066
:MODIFIED: 2019-03-05 17:15
:END:
...
** eshell
:PROPERTIES:
:HASH:     931114834085182346
:MODIFIED: 2019-03-05 17:15
:END:

Maybe some day I'll be good enough to use eshell...
...
:PROPERTIES:
:HASH:     323350578313107061
:MODIFIED: 2019-03-05 17:15
:END:

This works... but I really dislike the fact that it opens auto
complete suggestions in a separate buffer. Also, fish works really
well with =ansi-term=.
...
** shell-mode
:PROPERTIES:
:HASH:     2219397869461753545
:MODIFIED: 2019-03-05 17:15
:END:

NOTE: This isn't used. Maybe some day I'll figure out a way to enjoy
using =shell-mode= or =ansi-term=.
...
** Elisp for various things
:PROPERTIES:
:HASH:     -391112383145093235
:MODIFIED: 2019-03-05 17:15
:END:

*** Activate miscellaneous minor modes for arbitrary file names
:PROPERTIES:
:HASH:     2152944041743733024
:MODIFIED: 2019-03-05 17:15
:END:
...
(add-to-list 'auto-minor-mode-alist '("\\calendar.org\\'" . auto-revert-mode))
;; And don't tell me when it's been reverted
(setq auto-revert-verbose nil)
#+END_SRC

*** Testing/reloading init.el
:PROPERTIES:
:HASH:     1261172946643100622
:MODIFIED: 2019-03-05 17:15
:END:
...
(global-set-key (kbd "C-c t") 'ora-test-emacs)
#+END_SRC

** Try
:PROPERTIES:
:HASH:     -197119128755719431
:MODIFIED: 2019-03-05 17:15
:END:
...
** Which Key
:PROPERTIES:
:HASH:     1905220011752055783
:MODIFIED: 2019-03-05 17:15
:END:

This a nice package that helps Emacs neophytes such as myself. It lists
possible key chord completion given at least one key press.
